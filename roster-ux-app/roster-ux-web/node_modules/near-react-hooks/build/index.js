 ...
 */
exports.NearEnvironment = void 0;
...
})(exports.NearEnvironment || (exports.NearEnvironment = {}));

function getConfig(env) {
    switch (env) {
        case exports.NearEnvironment.MainNet:
            return {
                networkId: 'mainnet',
        ...
        case exports.NearEnvironment.BetaNet:
            return {
                networkId: 'betanet',
        ...
        case exports.NearEnvironment.Test:
            return {
                networkId: 'shared-test',
                nodeUrl: 'https://rpc.ci-testnet.near.org',
                masterAccount: 'test.near'
            };
        case exports.NearEnvironment.TestNet:
        default:
            return {
                networkId: 'testnet',
...
var serialize = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

Object.defineProperty(exports, "base_encode", { enumerable: true, get: function () { return lib$2.baseEncode; } });
Object.defineProperty(exports, "base_decode", { enumerable: true, get: function () { return lib$2.baseDecode; } });
Object.defineProperty(exports, "serialize", { enumerable: true, get: function () { return lib$2.serialize; } });
Object.defineProperty(exports, "deserialize", { enumerable: true, get: function () { return lib$2.deserialize; } });
Object.defineProperty(exports, "BorshError", { enumerable: true, get: function () { return lib$2.BorshError; } });
Object.defineProperty(exports, "BinaryWriter", { enumerable: true, get: function () { return lib$2.BinaryWriter; } });
Object.defineProperty(exports, "BinaryReader", { enumerable: true, get: function () { return lib$2.BinaryReader; } });
});
...
var key_pair = createCommonjsModule(function (module, exports) {
var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.KeyPairEd25519 = exports.KeyPair = exports.PublicKey = exports.KeyType = void 0;
const tweetnacl_1 = __importDefault(naclFast);
 ...
 */
class PublicKey extends enums.Assignable {
    static from(value) {
        if (typeof value === 'string') {
    ...
    static fromString(encodedKey) {
        ...
        if (parts.length === 1) {
            return new PublicKey({ keyType: KeyType.ED25519, data: serialize.base_decode(parts[0]) });
        }
        else if (parts.length === 2) {
            return new PublicKey({ keyType: str_to_key_type(parts[0]), data: serialize.base_decode(parts[1]) });
        }
        else {
    ...
    toString() {
        return `${key_type_to_str(this.keyType)}:${serialize.base_encode(this.data)}`;
    }
}
...
class KeyPairEd25519 extends KeyPair {
    ...
    constructor(secretKey) {
        super();
        const keyPair = tweetnacl_1.default.sign.keyPair.fromSecretKey(serialize.base_decode(secretKey));
    ...
    static fromRandom() {
        ...
        return new KeyPairEd25519(serialize.base_encode(newKeyPair.secretKey));
    }
    sign(message) {
        const signature = tweetnacl_1.default.sign.detached(message, serialize.base_decode(this.secretKey));
...
var in_memory_key_store = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
 ...
 * ```
 */
class InMemoryKeyStore extends keystore.KeyStore {
    constructor() {
        super();
        this.keys = {};
    }
    ...
    async getKey(networkId, accountId) {
        ...
        return key_pair.KeyPair.fromString(value);
    }
    /**
...
var browser_local_storage_key_store = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
 ...
 * ```
 */
class BrowserLocalStorageKeyStore extends keystore.KeyStore {
    /**
...
var unencrypted_file_system_keystore = createCommonjsModule(function (module, exports) {
var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
...
const path_1 = __importDefault(require$$1__default['default']);
...
const promisify = (fn) => {
    ...
    return util_1__default['default'].promisify(fn);
};
...
async function readKeyFile(filename) {
    ...
    return [accountInfo.account_id, key_pair.KeyPair.fromString(privateKey)];
}
 ...
 * ```
 */
class UnencryptedFileSystemKeyStore extends keystore.KeyStore {
    /**
...
var merge_key_store = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.MergeKeyStore = void 0;

class MergeKeyStore extends keystore.KeyStore {
    /**
...
var key_stores = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
Object.defineProperty(exports, "KeyStore", { enumerable: true, get: function () { return keystore.KeyStore; } });

Object.defineProperty(exports, "InMemoryKeyStore", { enumerable: true, get: function () { return in_memory_key_store.InMemoryKeyStore; } });

Object.defineProperty(exports, "BrowserLocalStorageKeyStore", { enumerable: true, get: function () { return browser_local_storage_key_store.BrowserLocalStorageKeyStore; } });

Object.defineProperty(exports, "UnencryptedFileSystemKeyStore", { enumerable: true, get: function () { return unencrypted_file_system_keystore.UnencryptedFileSystemKeyStore; } });

Object.defineProperty(exports, "MergeKeyStore", { enumerable: true, get: function () { return merge_key_store.MergeKeyStore; } });
});
...
var _default$1 = exponentialBackoff;
// Sleep given number of millis.
function sleep(millis) {
    return new Promise(resolve => setTimeout(resolve, millis));
}

var exponentialBackoff_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$1
...
const http_errors_1 = __importDefault(httpErrors);
const exponential_backoff_1 = __importDefault(exponentialBackoff_1);
...
async function fetchJson(connection, json) {
    ...
    if (!response) {
        throw new providers.TypedError(`Exceeded ${RETRY_NUMBER} attempts for ${url}.`, 'RetriesExceeded');
    }
...
var rpc_errors = createCommonjsModule(function (module, exports) {
var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
...
const mustache_1 = __importDefault(mustache);
const rpc_error_schema_json_1 = __importDefault(require$$1);
const error_messages_json_1 = __importDefault(require$$2);


const mustacheHelpers = {
    formatNear: () => (n, render) => commonIndex.utils.format.formatNearAmount(render(n))
};
class ServerError extends errors.TypedError {
}
 ...
 */
const depd_1 = __importDefault(depd_1$1);



Object.defineProperty(exports, "TypedError", { enumerable: true, get: function () { return errors.TypedError; } });
Object.defineProperty(exports, "ErrorContext", { enumerable: true, get: function () { return errors.ErrorContext; } });
 ...
 */
class JsonRpcProvider extends provider.Provider {
    /**
    ...
    async txStatusUint8Array(txHash, accountId) {
        return this.sendJsonRpc('tx', [lib$2.baseEncode(txHash), accountId]);
    }
    ...
    async txStatusReceipts(txHash, accountId) {
        return this.sendJsonRpc('EXPERIMENTAL_tx_status', [lib$2.baseEncode(txHash), accountId]);
    }
    /**
    ...
    async query(...args) {
        ...
        if (result && result.error) {
            throw new errors.TypedError(`Querying ${args} failed: ${result.error}.\n${JSON.stringify(result, null, 2)}`, rpc_errors.getErrorTypeFromErrorMessage(result.error));
        }
        return result;
    }
    /**
    ...
    async sendJsonRpc(method, params) {
        const response = await exponential_backoff_1.default(REQUEST_RETRY_WAIT, REQUEST_RETRY_NUMBER, REQUEST_RETRY_WAIT_BACKOFF, async () => {
            try {
                ...
                const response = await web.fetchJson(this.connection, JSON.stringify(request));
                if (response.error) {
                    if (typeof response.error.data === 'object') {
                        if (typeof response.error.data.error_message === 'string' && typeof response.error.data.error_type === 'string') {
                            // if error data has error_message and error_type properties, we consider that node returned an error in the old format
                            throw new errors.TypedError(response.error.data.error_message, response.error.data.error_type);
                        }
                        throw rpc_errors.parseRpcError(response.error.data);
                    }
                    else {
                        ...
                        if (response.error.data === 'Timeout' || errorMessage.includes('Timeout error')
                            ...
                            throw new errors.TypedError(errorMessage, 'TimeoutError');
                        }
                        throw new errors.TypedError(errorMessage, rpc_errors.getErrorTypeFromErrorMessage(response.error.data));
                    }
                }
        ...
        if (typeof result === 'undefined') {
            throw new errors.TypedError(`Exceeded ${REQUEST_RETRY_NUMBER} attempts for request to ${method}.`, 'RetriesExceeded');
        }
        return result;
    }
}
...
Object.defineProperty(exports, "Provider", { enumerable: true, get: function () { return provider.Provider; } });
Object.defineProperty(exports, "getTransactionLastResult", { enumerable: true, get: function () { return provider.getTransactionLastResult; } });
Object.defineProperty(exports, "FinalExecutionStatusBasic", { enumerable: true, get: function () { return provider.FinalExecutionStatusBasic; } });

Object.defineProperty(exports, "JsonRpcProvider", { enumerable: true, get: function () { return jsonRpcProvider.JsonRpcProvider; } });
Object.defineProperty(exports, "TypedError", { enumerable: true, get: function () { return jsonRpcProvider.TypedError; } });
Object.defineProperty(exports, "ErrorContext", { enumerable: true, get: function () { return jsonRpcProvider.ErrorContext; } });
});
...
const serialize$1 = __importStar(serialize);
...
Object.defineProperty(exports, "PublicKey", { enumerable: true, get: function () { return key_pair.PublicKey; } });
Object.defineProperty(exports, "KeyPair", { enumerable: true, get: function () { return key_pair.KeyPair; } });
Object.defineProperty(exports, "KeyPairEd25519", { enumerable: true, get: function () { return key_pair.KeyPairEd25519; } });
});
...
const js_sha256_1 = __importDefault(sha256);



class FunctionCallPermission extends enums.Assignable {
}
exports.FunctionCallPermission = FunctionCallPermission;
class FullAccessPermission extends enums.Assignable {
}
exports.FullAccessPermission = FullAccessPermission;
class AccessKeyPermission extends enums.Enum {
}
exports.AccessKeyPermission = AccessKeyPermission;
class AccessKey extends enums.Assignable {
}
...
class IAction extends enums.Assignable {
}
...
exports.deleteAccount = deleteAccount;
class Signature extends enums.Assignable {
}
exports.Signature = Signature;
class Transaction extends enums.Assignable {
    encode() {
        return lib$2.serialize(exports.SCHEMA, this);
    }
    static decode(bytes) {
        return lib$2.deserialize(exports.SCHEMA, Transaction, bytes);
    }
}
exports.Transaction = Transaction;
class SignedTransaction extends enums.Assignable {
    encode() {
        return lib$2.serialize(exports.SCHEMA, this);
    }
    static decode(bytes) {
        return lib$2.deserialize(exports.SCHEMA, SignedTransaction, bytes);
    }
}
 ...
 */
class Action extends enums.Enum {
}
...
exports.SCHEMA = new Map([
    ...
    [key_pair.PublicKey, { kind: 'struct', fields: [
                ['keyType', 'u8'],
                ['data', [32]]
            ] }],
...
async function signTransactionObject(transaction, signer, accountId, networkId) {
    const message = lib$2.serialize(exports.SCHEMA, transaction);
...
class Account {
    ...
    async signTransaction(receiverId, actions) {
        ...
        if (!accessKeyInfo) {
            throw new providers.TypedError(`Can not sign transactions for account ${this.accountId} on network ${this.connection.networkId}, no matching key pair found in ${this.connection.signer}.`, 'KeyNotFound');
        }
        const { accessKey } = accessKeyInfo;
        const block = await this.connection.provider.block({ finality: 'final' });
        const blockHash = block.header.hash;
        const nonce = ++accessKey.nonce;
        return await transaction.signTransaction(receiverId, nonce, actions, lib$2.baseDecode(blockHash), this.connection.signer, this.accountId, this.connection.networkId);
    }
    ...
    async signAndSendTransactionV2({ receiverId, actions }) {
        ...
        const result = await exponential_backoff_1.default(TX_NONCE_RETRY_WAIT, TX_NONCE_RETRY_NUMBER, TX_NONCE_RETRY_WAIT_BACKOFF, async () => {
            ...
            try {
                ...
                if (error.type === 'InvalidNonce') {
                    console.warn(`Retrying transaction ${receiverId}:${lib$2.baseEncode(txHash)} with new nonce.`);
                    delete this.accessKeyByPublicKeyCache[publicKey.toString()];
                    return null;
                }
                error.context = new providers.ErrorContext(lib$2.baseEncode(txHash));
                throw error;
            }
        });
        if (!result) {
            // TODO: This should have different code actually, as means "transaction not submitted for sure"
            throw new providers.TypedError('nonce retries exceeded for transaction. This usually means there are too many parallel requests with the same access key.', 'RetriesExceeded');
        }
        const flatLogs = [result.transaction_outcome, ...result.receipts_outcome].reduce((acc, it) => {
            if (it.outcome.logs.length ||
                ...
                return acc.concat({
                    ...
                    'failure': typeof it.outcome.status.Failure != 'undefined' ? rpc_errors.parseRpcError(it.outcome.status.Failure) : null
                });
            }
            else
                return acc;
        ...
        if (typeof result.status === 'object' && typeof result.status.Failure === 'object') {
            ...
            if (result.status.Failure.error_message && result.status.Failure.error_type) {
                throw new providers.TypedError(`Transaction ${result.transaction_outcome.id} failed. ${result.status.Failure.error_message}`, result.status.Failure.error_type);
            }
            else {
                throw rpc_errors.parseResultError(result);
            }
        }
    ...
    async createAndDeployContract(contractId, publicKey, data, amount) {
        const accessKey = transaction.fullAccessKey();
        await this.signAndSendTransaction({
            receiverId: contractId,
            actions: [transaction.createAccount(), transaction.transfer(amount), transaction.addKey(key_pair.PublicKey.from(publicKey), accessKey), transaction.deployContract(data)]
        });
    ...
    async sendMoney(receiverId, amount) {
        return this.signAndSendTransaction({
            receiverId,
            actions: [transaction.transfer(amount)]
        });
    }
    /**
    ...
    async createAccount(newAccountId, publicKey, amount) {
        ...
        return this.signAndSendTransaction({
            ...
            actions: [transaction.createAccount(), transaction.transfer(amount), transaction.addKey(key_pair.PublicKey.from(publicKey), accessKey)]
        });
    }
    /**
    ...
    async deleteAccount(beneficiaryId) {
        return this.signAndSendTransaction({
            ...
            actions: [transaction.deleteAccount(beneficiaryId)]
        });
    }
    /**
     * @param data The compiled contract code
    ...
    async deployContract(data) {
        return this.signAndSendTransaction({
            receiverId: this.accountId,
            actions: [transaction.deployContract(data)]
        });
    }
    ...
    functionCallV1(contractId, methodName, args, gas, amount) {
        ...
        return this.signAndSendTransaction({
            receiverId: contractId,
            actions: [transaction.functionCall(methodName, args, gas || constants.DEFAULT_FUNCTION_CALL_GAS, amount)]
        });
    }
    functionCallV2({ contractId, methodName, args = {}, gas = constants.DEFAULT_FUNCTION_CALL_GAS, attachedDeposit, walletMeta, walletCallbackUrl }) {
        this.validateArgs(args);
        return this.signAndSendTransaction({
            receiverId: contractId,
            actions: [transaction.functionCall(methodName, args, gas, attachedDeposit)],
            walletMeta,
            walletCallbackUrl
        });
    }
    ...
    async addKey(publicKey, contractId, methodNames, amount) {
        ...
        let accessKey;
        if (!contractId) {
            accessKey = transaction.fullAccessKey();
        }
        else {
            accessKey = transaction.functionCallAccessKey(contractId, methodNames, amount);
        }
        return this.signAndSendTransaction({
            receiverId: this.accountId,
            actions: [transaction.addKey(key_pair.PublicKey.from(publicKey), accessKey)]
        });
    }
    /**
    ...
    async deleteKey(publicKey) {
        return this.signAndSendTransaction({
            receiverId: this.accountId,
            actions: [transaction.deleteKey(key_pair.PublicKey.from(publicKey))]
        });
    }
    /**
    ...
    async stake(publicKey, amount) {
        return this.signAndSendTransaction({
            receiverId: this.accountId,
            actions: [transaction.stake(amount, key_pair.PublicKey.from(publicKey))]
        });
    }
    /** @hidden */
    validateArgs(args) {
        ...
        if (Array.isArray(args) || typeof args !== 'object') {
            throw new errors.PositionalArgsError();
        }
    }
    /**
...
var account_multisig = createCommonjsModule(function (module, exports) {
var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.MULTISIG_ALLOWANCE = new bn_js_1.default(format.parseNearAmount('1'));
...
class AccountMultisig extends account.Account {
    ...
    async _signAndSendTransaction({ receiverId, actions }) {
        ...
        try {
            result = await super.signAndSendTransaction({
                ...
                actions: [
                    transaction.functionCall('add_request_and_confirm', args, exports.MULTISIG_GAS, exports.MULTISIG_DEPOSIT)
                ]
            });
        }
        catch (e) {
        ...
        for (const requestIdToDelete of request_ids) {
            ...
            try {
                await super.signAndSendTransaction({
                    receiverId: this.accountId,
                    actions: [transaction.functionCall('delete_request', { request_id: requestIdToDelete }, exports.MULTISIG_GAS, exports.MULTISIG_DEPOSIT)]
                });
            }
            catch (e) {
...
class Account2FA extends AccountMultisig {
    ...
    async deployMultisig(contractBytes) {
        ...
        const actions = [
            ...fak2lak.map((pk) => transaction.deleteKey(pk)),
            ...fak2lak.map((pk) => transaction.addKey(pk, transaction.functionCallAccessKey(accountId, exports.MULTISIG_CHANGE_METHODS, null))),
            transaction.addKey(confirmOnlyKey, transaction.functionCallAccessKey(accountId, exports.MULTISIG_CONFIRM_METHODS, null)),
            transaction.deployContract(contractBytes),
        ];
        if ((await this.state()).code_hash === '11111111111111111111111111111111') {
            actions.push(transaction.functionCall('new', newArgs, exports.MULTISIG_GAS, exports.MULTISIG_DEPOSIT));
        }
    ...
    async disable(contractBytes) {
        ...
        const confirmOnlyKey = key_pair.PublicKey.from((await this.postSignedJson('/2fa/getAccessKey', { accountId })).publicKey);
        const actions = [
            transaction.deleteKey(confirmOnlyKey),
            ...lak2fak.map(({ public_key }) => transaction.deleteKey(key_pair.PublicKey.from(public_key))),
            ...lak2fak.map(({ public_key }) => transaction.addKey(key_pair.PublicKey.from(public_key), null)),
            transaction.deployContract(contractBytes),
        ];
    ...
    async postSignedJson(path, body) {
        return await web.fetchJson(this.helperUrl + path, JSON.stringify({
            ...body,
...
// helpers
const toPK = (pk) => key_pair.PublicKey.from(pk);
...
var account_creator = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class UrlAccountCreator extends AccountCreator {
     ...
     */
    async createAccount(newAccountId, publicKey) {
        await web.fetchJson(`${this.helperUrl}/account`, JSON.stringify({ newAccountId, newAccountPublicKey: publicKey.toString() }));
    }
}
...
class InMemorySigner extends Signer {
    ...
    static async fromKeyPair(networkId, accountId, keyPair) {
        const keyStore = new in_memory_key_store.InMemoryKeyStore();
    ...
    async createKey(accountId, networkId) {
        const keyPair = key_pair.KeyPair.fromRandom('ed25519');
...
function getProvider(config) {
    switch (config.type) {
        case undefined:
            return config;
        case 'JsonRpcProvider': return new providers.JsonRpcProvider(config.args.url);
...
function getSigner(config) {
    switch (config.type) {
        case undefined:
            return config;
        case 'InMemorySigner': {
            return new signer.InMemorySigner(config.keyStore);
        }
...
class Contract {
    ...
    async _changeMethod({ args, methodName, gas, amount, meta, callbackUrl }) {
        ...
        return providers.getTransactionLastResult(rawResult);
    }
}
...
function validateBNLike(argMap) {
    ...
    for (const argName of Object.keys(argMap)) {
        ...
        if (argValue && !bn_js_1.default.isBN(argValue) && isNaN(argValue)) {
            throw new errors.ArgumentTypeError(argName, bnLike, argValue);
        }
    }
}
});

var near = createCommonjsModule(function (module, exports) {
var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
...
class Near {
    constructor(config) {
        this.config = config;
        this.connection = connection.Connection.fromConfig({
        ...
        if (config.masterAccount) {
            ...
            this.accountCreator = new account_creator.LocalAccountCreator(new account.Account(this.connection, config.masterAccount), initialBalance);
        }
        else if (config.helperUrl) {
            this.accountCreator = new account_creator.UrlAccountCreator(this.connection, config.helperUrl);
        }
        else {
    ...
    async account(accountId) {
        const account$1 = new account.Account(this.connection, accountId);
        return account$1;
    }
    /**
    ...
    async createAccount(accountId, publicKey) {
        ...
        return new account.Account(this.connection, accountId);
    }
    /**
    ...
    async loadContract(contractId, options) {
        const account$1 = new account.Account(this.connection, options.sender);
        return new contract.Contract(account$1, contractId, options);
    }
    /**
    ...
    async sendTokens(amount, originator, receiver) {
        ...
        const account$1 = new account.Account(this.connection, originator);
        const result = await account$1.sendMoney(receiver, amount);
...
var walletAccount = createCommonjsModule(function (module, exports) {
var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
...
class WalletConnection {
    ...
    async _requestSignTransactions({ transactions, meta, callbackUrl }) {
        ...
        newUrl.searchParams.set('transactions', transactions
            .map(transaction$1 => borsh_2.serialize(transaction.SCHEMA, transaction$1))
 ...
 */
class ConnectedWalletAccount extends account.Account {
    ...
    async _signAndSendTransaction({ receiverId, actions, walletMeta, walletCallbackUrl = window.location.href }) {
        ...
        const block = await this.connection.provider.block({ finality: 'final' });
        const blockHash = lib$2.baseDecode(block.header.hash);
        const publicKey = utils.PublicKey.from(accessKey.public_key);
        // TODO: Cache & listen for nonce updates for given access key
        const nonce = accessKey.access_key.nonce + 1;
        const transaction$1 = transaction.createTransaction(this.accountId, publicKey, receiverId, nonce, actions, blockHash);
...
var commonIndex = createCommonjsModule(function (module, exports) {
var __createBinding = (commonjsGlobal && commonjsGlobal.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
}) : (function(o, m, k, k2) {
...
Object.defineProperty(exports, "Account", { enumerable: true, get: function () { return account.Account; } });
const multisig = __importStar(account_multisig);
exports.multisig = multisig;
const accountCreator = __importStar(account_creator);
exports.accountCreator = accountCreator;

Object.defineProperty(exports, "Connection", { enumerable: true, get: function () { return connection.Connection; } });

Object.defineProperty(exports, "Signer", { enumerable: true, get: function () { return signer.Signer; } });
Object.defineProperty(exports, "InMemorySigner", { enumerable: true, get: function () { return signer.InMemorySigner; } });

Object.defineProperty(exports, "Contract", { enumerable: true, get: function () { return contract.Contract; } });

Object.defineProperty(exports, "KeyPair", { enumerable: true, get: function () { return key_pair.KeyPair; } });

Object.defineProperty(exports, "Near", { enumerable: true, get: function () { return near.Near; } });
// TODO: Deprecate and remove WalletAccount

Object.defineProperty(exports, "ConnectedWalletAccount", { enumerable: true, get: function () { return walletAccount.ConnectedWalletAccount; } });
Object.defineProperty(exports, "WalletAccount", { enumerable: true, get: function () { return walletAccount.WalletAccount; } });
Object.defineProperty(exports, "WalletConnection", { enumerable: true, get: function () { return walletAccount.WalletConnection; } });
});
...
const https_1 = __importDefault(https__default['default']);
...
var setupNodeFetch = /*#__PURE__*/Object.defineProperty({
	default: _default
}, '__esModule', {value: true});
...
async function connect(config) {
    ...
    if (config.keyPath && (config.keyStore || config.deps && config.deps.keyStore)) {
        try {
            const accountKeyFile = await unencrypted_file_system_keystore.readKeyFile(config.keyPath);
            if (accountKeyFile[0]) {
                // TODO: Only load key if network ID matches
                const keyPair = accountKeyFile[1];
                const keyPathStore = new key_stores.InMemoryKeyStore();
                await keyPathStore.setKey(config.networkId, accountKeyFile[0], keyPair);
                if (!config.masterAccount) {
                    config.masterAccount = accountKeyFile[0];
                }
                config.keyStore = new key_stores.MergeKeyStore([
                    keyPathStore,
...
__exportStar(connect_1, exports);
 ...
 * @ignore
 */
var NearContext = React__default['default'].createContext({});
/**
 ...
 * ```
 */
var NearProvider = function (_a) {
    var _b = _a.environment, environment = _b === void 0 ? exports.NearEnvironment.TestNet : _b, children = _a.children, props = __rest(_a, ["environment", "children"]);
    var config = __assign(__assign(__assign({}, getConfig(environment)), { deps: { keyStore: new lib.keyStores.BrowserLocalStorageKeyStore() } }), props);
    var _c = React.useState(), near = _c[0], setNear = _c[1];
    var _d = React.useState(), wallet = _d[0], setWallet = _d[1];
        ...
        function setup() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, lib.connect(config)];
                        case 1:
                            near = _a.sent();
                            wallet = new lib.WalletConnection(near, null);
                            setNear(near);
                            setWallet(wallet);
                            return [2 /*return*/];
                    }
    ...
    return (React__default['default'].createElement(NearContext.Provider, { value: { near: near, wallet: wallet } }, near !== undefined && wallet !== undefined ? children : null));
};

var useNear = function () {
    var near = React.useContext(NearContext).near;
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return near;
};
var useNearWallet = function () {
    var wallet = React.useContext(NearContext).wallet;
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return wallet;
};
/**
  ...
  */
var useNearContract = function (contractId, contractMethods) {
    var wallet = useNearWallet();
    return new lib.Contract(wallet.account(), contractId, contractMethods);
};
 ...
 */
var NearSignin = function (_a) {
    var _b = _a.text, text = _b === void 0 ? 'Signin with NEAR' : _b, className = _a.className, style = _a.style, rest = __rest(_a, ["text", "className", "style"]);
    var wallet = useNearWallet();
    if (wallet.isSignedIn()) {
        return (React__default['default'].createElement("p", { className: className, style: className !== undefined ? null : style !== undefined ? style : DEFAULT_STYLE }, wallet.getAccountId()));
    }
    else {
        return (React__default['default'].createElement("button", { className: className, style: className !== undefined ? null : style !== undefined ? style : DEFAULT_STYLE, onClick: function () { return wallet.requestSignIn(rest); } }, text));
    }
};

exports.NearProvider = NearProvider;
exports.NearSignin = NearSignin;
exports.useNear = useNear;
exports.useNearContract = useNearContract;
